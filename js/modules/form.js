export default function initFormContanct() {
  ...
  if (form) {
    ...
    function sentForm(response) {
      if (response.ok) {
        form.innerHTML =
          "<p style='padding-block: 1rem; grid-column: 1/-1; justify-self: center;'><span style='color: var(--clr-typewriter);'>Messange sent successfully</span>.<br> i will contact you soon</p>";
      } else {
        form.innerHTML =
